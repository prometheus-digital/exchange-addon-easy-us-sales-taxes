...
(function ($) {
	...
	AUSTCertManager.ListCertsView = Backbone.View.extend({
		...
		initialize : function() {
			...
			this.listenTo( AUSTCertManager.certificates, 'reset', this.addAll );
		},
	...
	var it_exchange_aust_refresh_cart = function() {
		var pathname = window.location.pathname;
		if ( 'undefined' !== typeof itExchangeSWState ){
			console.log( itExchangeSWState );
			//refresh the superwidget
			itExchangeGetSuperWidgetState( itExchangeSWState );
		}
		console.log( pathname );
		//refresh the page we're on
		console.log( 'it_exchange_aust_refresh_cart' );
	}
})(jQuery);
