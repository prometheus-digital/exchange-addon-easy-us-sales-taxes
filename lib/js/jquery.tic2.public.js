...
jQuery(document).ready(function () {
    ...
    if (checkRequirements(reqs)) {
        ...
        jQuery('#catList').html('');
        jQuery('#jqTicFinal').html('<select style="' + ddlcss + '" id="' + fieldID + '" onchange="getTic(this)"><option>[ Loading... ]</option></select>');
...
function showTic() {
    if (ct.length != 5) {
        ...
        jQuery('#catList').html("");jQuery('#jqTicFinal').html('<select style="' + ddlcss + '" id="' + fieldID + '" onchange="getTic(this)"><option>[ Loading... ]</option></select>');
        ...
        jQuery('#catList').html(""); jQuery('#jqTicFinal').html("<input type='hidden' id='" + fieldID + "' value='" + ct + "'/>"); jQuery('#ticComplete').html("");
...
function getTic(whichTic) {
    if (whichTic.value == 'reset') {
        startTic();
		if( 0 !== jQuery( 'input[name="it-exchange-add-on-advanced-us-taxes-us-tic-desc"]' ).length )
			jQuery( 'input[name="it-exchange-add-on-advanced-us-taxes-us-tic-desc"]' ).val( '' );
    }else{
        var ticSelector = jQuery("#" + fieldID);
		...
		if( 0 !== jQuery( 'input[name="it-exchange-add-on-advanced-us-taxes-us-tic-desc"]' ).length )
			jQuery( 'input[name="it-exchange-add-on-advanced-us-taxes-us-tic-desc"]' ).val( selectedLabel );
